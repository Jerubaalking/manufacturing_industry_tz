...
{{--<body>--}}
                <div class="section__content section__content--p30">
                    ...
                    <center><h3 style="margin-left:30px;margin-top:-10px;"><strong style="color:green">{{$product_out[0]->first_name}} -- {{$product_out[0]->last_name}}  <span style="color:red">  Sales  Report</span></h3></center>
