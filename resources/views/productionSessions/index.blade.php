...
@section('content')
    <div class="box">     
    <h3 class="title-5 m-b-35">Into Store Details</h3>  
...
@include('productionSessions.form');
...
<script src="https://cdn.datatables.net/buttons/2.1.0/js/buttons.print.min.js"></script>
    ...
    <script type="text/javascript">
            ...
            $('#add_btn').on('click',function(){
                ...
                $('#form-item')[0].reset();
                $('.modal-title').text('Add Production Session');
    ...
    function editForm(id) {
        ...
        save_method = 'edit';
            ...
            $('#form-item')[0].reset();
            $.ajax({
                url:"{{ url('productionSessions') }}" + '/' + id + "/edit",
        ...
        $(function(){
            $('#modal-form form').validator().on('submit', function (e) {
                ...
                if (e.isDefaultPrevented()){
                    var id = $('#id').val();
                    if (save_method == 'add') url = "{{ url('productionSessions') }}";
                    else url = "{{ url('productionSessions') . '/' }}" + id;
                    $.ajax({
                        url : url,
                        type : "POST",
