...
{{--<body>--}}
                <div class="section__content section__content--p30">
                    ...
                    <center><h3 style="margin-left:30px;margin-top:-10px;"><strong style="color:green">Measurement Scheme Report<p style="color:red">From</p>{{$from}}<p style="color:red">To</p>{{$to}}</strong></h3></center>
        ...
        <div class="table-responsive">
                                    <table class="table">
                                        <thead>
                                            <tr>          
                                 <th scope="col" class="border-0 pl-0">Measure</th>
                                 <th scope="col" class="border-0 pl-0">Symbol</th>
                                 <th scope="col" class="border-0 pl-0">Description</th>  
                                 <th scope="col" class="border-0 pl-0">Type</th>  
                                            </tr>
                                        </thead>
