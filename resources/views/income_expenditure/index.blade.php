                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="col-lg-6">
                                ...
                                <div class="top-campaign">
                                    <h3 class="title-3 m-b-30">Income and Expenditure</h3>
                                    <div class="table-responsive">
                                        <table class="table table-top-campaign">
                                            <tbody> 
                                                ...
                                                <tr>
                                                    <td style="color:green">Profit/Loss((A-B)</td>
                    ...
                    <div class="col-lg-6">
                     ...
                     <h3 class="title-3 m-b-30">Export</h3>
                           <form action="profit_loss" method="POST" enctype="multipart/form-data">
