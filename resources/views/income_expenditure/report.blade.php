...
<style type="text/css" media="screen">
    ...
    <img src="assets/img/misana.png" height="100%" width="100%" style="opacity: 0.05;"/>
      ...
      <center><h3 style="margin-left:30px;margin-top:-10px;"><strong style="color:green">Profit and Loss Report<p style="color:red">From</p>{{$from}}<p style="color:red">To</p>{{$to}}</strong></h3></center>
      ...
      <div class="table-responsive">
                                        <table class="table table-top-campaign">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td style="color:red">Expenses(B)</td>
                                                    <td style="color:red">{{number_format($expense_sum,2)}}</td>
                                                </tr>
                                                <tr>
                                                    <td style="color:green">Profit/Loss((A-C)</td>
